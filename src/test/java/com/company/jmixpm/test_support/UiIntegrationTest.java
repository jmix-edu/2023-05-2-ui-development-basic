...
import com.company.jmixpm.UiDevelopmentBasicApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.jmixpm.screen")
@ContextConfiguration(classes = {UiDevelopmentBasicApplication.class, UiTestAssistConfiguration.class})
